...
def k4a_image_create_from_buffer(image_format, width, height, stride, buffer, buffer_size, buffer_release_cb,
                                 buffer_release_cb_context, image_handle):
    """
    ...
    return _k4a_image_create_from_buffer(image_format, width, height, stride, buffer, buffer_size, buffer_release_cb,
                                         buffer_release_cb_context, image_handle)
...
def k4a_device_get_color_control_capabilities(device_handle, command, supports_auto, min_value, max_value, step_value,
    ...
    return _k4a_device_get_color_control_capabilities(device_handle, command, supports_auto, min_value, max_value,
                                                      step_value, default_value, default_mode)
...
def k4a_calibration_get_from_raw(raw_calibration, raw_calibration_size, depth_mode, color_resolution, calibration):
    ...
    return _k4a_calibration_get_from_raw(raw_calibration, raw_calibration_size, depth_mode, color_resolution,
                                         calibration)
...
def k4a_calibration_2d_to_3d(calibration, source_point2d, source_depth_mm, source_camera, target_camera,
    ...
    return _k4a_calibration_2d_to_3d(calibration, source_point2d, source_depth_mm, source_camera, target_camera,
                                     target_point3d_mm, valid)
...
def k4a_calibration_3d_to_2d(calibration, source_point3d_mm, source_camera, target_camera, target_point2d, valid):
    ...
    return _k4a_calibration_3d_to_2d(calibration, source_point3d_mm, source_camera, target_camera, target_point2d,
                                     valid)


def k4a_calibration_2d_to_2d(calibration, source_point2d, source_depth_mm, source_camera, target_camera, target_point2d,
                             valid):
    """
    ...
    return _k4a_calibration_2d_to_2d(calibration, source_point2d, source_depth_mm, source_camera, target_camera,
...
def k4a_transformation_depth_image_to_color_camera_custom(transformation_handle, depth_image, custom_image,
                                                          transformed_depth_image, transformed_custom_image,
                                                          interpolation_type, invalid_custom_value):
    """
    ...
    return _k4a_transformation_depth_image_to_color_camera_custom(transformation_handle, depth_image, custom_image,
                                                                  transformed_depth_image, transformed_custom_image,
                                                                  interpolation_type, invalid_custom_value)


def k4a_transformation_color_image_to_depth_camera(transformation_handle, depth_image, color_image,
    ...
    return _k4a_transformation_color_image_to_depth_camera(transformation_handle, depth_image, color_image,
                                                           transformed_color_image)
